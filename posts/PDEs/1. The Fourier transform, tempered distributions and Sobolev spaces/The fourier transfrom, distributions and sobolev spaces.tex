...
\begin{lemma}[\textbf{Sobolev Embedding into Continuous Functions}]
...
\begin{proof}
	...
	is absolutely convergent (by \Cref{Sobolevacseriesperiodic}), and hence, we may commute the derivatives of $f$ with the sum in its Fourier series to deduce the point-wise equality
