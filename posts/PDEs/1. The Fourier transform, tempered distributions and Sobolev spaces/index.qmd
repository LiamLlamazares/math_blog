...
[Download PDF version](The%20fourier%20transfrom%2C%20distributions%20and%20sobolev%20spaces.pdf)
:::
...
2. If $x^\alpha f(x)\in L^1(\R^d\to\C^m)$ then:\quad \[D^\alpha \hat{f}(\xi)=(-2\pi i)^\abs{\alpha}\widehat{x^{\alpha} f}(\xi)\qquad\forall \xi\in\R^d.\]
...
\bigbreak $\mathcal{F}_\mathcal{S}$ and $\mathcal{F}_\mathcal{S}^*$ may be extended to unitary operators:
