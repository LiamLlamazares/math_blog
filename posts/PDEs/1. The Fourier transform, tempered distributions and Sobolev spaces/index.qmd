...
1. [a)]
2. $f(t)$ is measurable for every $t\in U$ and integrable for some $t_0\in U$.
3. For each $x\in X$ we have that $f(x)$ is differentiable and there exists an integrable function $g: X\to\R$ such that
