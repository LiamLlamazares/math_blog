...
::: {#lem-1 name="**Sobolev Embedding into Continuous Functions**"}
...
The proof is an application of the Cauchy-Schwartz inequality and (@thm-hsisl1periodic). We have that
\begin{multline*}
...
By (@thm-sobolev-derivatives-embedding-periodic),
...
is absolutely convergent (by @thm-sobolevacseriesperiodic), and hence, we may commute the derivatives of $f$ with the sum in its Fourier series to deduce the point-wise equality
