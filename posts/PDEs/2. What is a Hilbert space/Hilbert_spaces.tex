...
\begin{document}
	...
	\begin{proof}
		...
		\end{align}
		As a result, we deduce from the corollary of the orthogonal complement \Cref{cor} that $\overline{\Im(\Ll)}=0$. Thus, if we show that $\Ll$ is closed invertibility follows. The estimate in \eqref{est} together with Cauchy Schwartz show that for all $u \in H$
		\begin{align*}
			\norm{ \Ll u}\geq \norm{u}.
		\end{align*}
