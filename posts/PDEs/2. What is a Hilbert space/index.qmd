...
aliases:
  - /2023-05-30-PDE-2-Hilbert/
bibliography: biblio.bib
pdf: "Hilbert_spaces.pdf"
resources:
  - "Hilbert_spaces.pdf"
format:
  html:
...
<div id="quarto-post-pdf-url" data-url="Hilbert_spaces.pdf" style="display:none;"></div>

\postaliases{/2023-05-30-PDE-2-Hilbert/}
...
Note that the imposition that $V$ is closed in @thm-complement-theorem is necessary. Finite-dimensional subspaces are always closed, but infinite-dimensional subspaces may not be. For example, consider $H=L^2(I)$ for some bounded $I$ and take  $V$ to polynomials on $I$ . By the <https://en.wikipedia.org/wiki/Stone
...
As a result by <https://en.wikipedia.org/wiki/Zorn
...
The first part again follows fromb the last equivalent characterization in @prp-equivalent.  The second part relies on the fact that in complete spaces compact and <https://en.wikipedia.org/wiki/Totally_bounded_space#:~:text=not
...
::: {#thm-fredholm name="Fredholm alternative"}
