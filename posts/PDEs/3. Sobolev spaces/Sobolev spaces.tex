...
\begin{theorem}[Rellich-Kondrachov]\label{rellich}
	...
	Where $p^{k*}$ is defined by the relation $\frac{1}{p^{k*}}=\frac{1}{p}-\frac{k}{d}$ and $\gamma =1 -\frac{d}{p}$. Furthermore, the first, second, fourth, and third composed with fourth inclusions are \href{https://en.wikipedia.org/wiki/Compact_embedding}{compact}.
\end{theorem}
\begin{exercise}
