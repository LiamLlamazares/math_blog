...
Where $p_k^*$ is defined by the relation $\frac{1}{p_k^*}=\frac{1}{p}-\frac{k}{d}$ and $\gamma =1 -\frac{d}{p}$. Furthermore, the first, second, fourth, and third composed with fourth inclusions are [compact](<https://en.wikipedia.org/wiki/Compact_embedding>).
...
::: {#def-13 name="Convolution of functions"}
...
::: {#def-14 name="Convolution of function with measure"}
...
::: {#def-15 name="Convolution of measures"}
