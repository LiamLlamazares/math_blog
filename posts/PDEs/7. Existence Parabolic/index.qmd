...
[Download PDF version](Parabolic.pdf)
:::
...
![Galerkin solution to the parabolic problem ([-@eq-parabolic-2]) with $n=3$ basis functions.](Galerkin_n_3.png)

![Galerkin solution to the parabolic problem ([-@eq-parabolic-2]) with $n=20$ basis functions.](Galerkin_n_20.png)
...
![Approximation of $g=1$ in $L^2(U)$ using the basis functions $\phi_j \in H_0^1(U)$.](approx_boundary_l2.png)
...
![Exact solution to the parabolic problem ([-@eq-exact]). ](Galerkin_exact.png)

![Galerkin solution to the parabolic problem ([-@eq-exact]) with $n=20$ basis functions.](Galerkin_n_20_2.png)
