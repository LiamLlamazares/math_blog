...
Under Assumption @ass, we say that $u$ is a *weak solution of the parabolic problem* @eq-parabolic if
...
Under Assumption @ass, the Galerkin problem @eq-galerkin is well-posed. That is, a unique solution $u_n$ exists and depends continuously on the initial data. Furthermore,
...
Under Assumption @ass, the parabolic problem @eq-parabolic is well-posed. That is, there exists a unique weak solution $u$, which depends continuously on the initial data with
