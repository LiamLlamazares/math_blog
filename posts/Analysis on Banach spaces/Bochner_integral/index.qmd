...
The dominated convergence theorem is a powerful tool that allows us to pass to the limit under the integral sign. For example, it can be used to show that, under necessary conditions, if $f(t,\omega )$ is continuous (differentiable) in $t$ then so is $\int f(t,\omega )\d\mu(\omega)$ (see [here](<https://nowheredifferentiable.com/2023-01-29-PDE-1-Fourier/#:~:text=assumed%20for%20commodity.-,Proposition%201,-(Continuity%20of%20the>) for a proof). These results, together with the density of simple functions, can be used to prove the [standard approximation theorems](<https://nowheredifferentiable.com/2023-07-12-PDEs-3-Sobolev_spaces/#:~:text=example%2C%208%20444R.-,Smoothing,-in>).
