...
\begin{corollary}\label{normedspace}
	$(\mathbb{D}_{1,2},\|\cdot \|_{\mathbb{D}_{1,2}})$ is a inner product space. Furthermore
	\begin{equation*}
...
\end{proposition}
\begin{proof}
It only remains to show that $\norm{\cdot }_{\mathbb{D}_{1,2}}$ is complete. Let $\set{X_m}_{m \in \N} \subset  \mathbb{D}_{1,2}$ be Cauchy. Or equivalently, by \Cref{normedspace}, $X_m$ is Cauchy in $L^2(\Omega)$ and $DX$ in $L^2(I \times \Omega)$.
