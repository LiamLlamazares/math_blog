...
aliases:
  - /2022-06-10-Malliavin-Calculus-2/
format:
  html:
    toc: true
...
\postaliases{/2022-06-10-Malliavin-Calculus-2/}
...
The same as in [the previous post](</posts/Malliavin Calculus/1.Chaos_expansion/index.qmd>) on the chaos expansion. We will also write $\mathbb{L}^2(I\times \Omega)$ for the space of  [Itô integrable](</posts/Stochastic Calculus/Ito_integral/index.qmd>) functions.
