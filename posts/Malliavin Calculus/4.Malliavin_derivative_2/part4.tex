...
\begin{document}
\title{MC 4: The Malliavin derivative, part 2}
\postaliases{/2022-07-02-Malliavin-Calculus-4/}
\postsubtitle{Part 4 of the series on Malliavin calculus}
...
\[
	...
	= \qty(\int_0^\cdot D_t{X}(\omega) \, \d{t},
...
\begin{theorem}\label{divergence prop}
