...
\postsubtitle{Part 5 of the series on Malliavin calculus}
	...
	\begin{proof}
		...
		Now take a smooth and bounded function $\varphi$ with $\varphi(y)=0$ for $y<x-\varepsilon $ and with $\varphi(y)=1$ for $y>x+\varepsilon$. By \eqref{sup} it holds that (almost everywhere) $\varphi(X)=1_{X>x+\varepsilon}$. Combining \postref{Malliavin Calculus/3.Malliavin_derivative_1}{prp-5}{proposition 5} and \postref{Malliavin Calculus/3.Malliavin_derivative_1}{cor-1}{corollary 1} of the previous post, we obtain that $1_{X>x+\varepsilon}$ is either $0$ or $1$ almost everywhere. That is,
