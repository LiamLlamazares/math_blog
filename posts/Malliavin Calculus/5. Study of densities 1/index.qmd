...
Now take a smooth and bounded function $\varphi$ with $\varphi(y)=0$ for $y<x-\epsilon$ and with $\varphi(y)=1$ for $y>x+\epsilon$. By @eq-sup it holds that (almost everywhere) $\varphi(X)=1_{X>x+\epsilon}$. Combining [proposition 5](../../Malliavin Calculus/3.Malliavin_derivative_1/index.qmd#prp-5) and [corollary 1](../../Malliavin Calculus/3.Malliavin_derivative_1/index.qmd#cor-1) of the previous post, we obtain that $1_{X>x+\epsilon}$ is either $0$ or $1$ almost everywhere. That is,
