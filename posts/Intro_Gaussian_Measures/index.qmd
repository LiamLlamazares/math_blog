...
date: "2026-02-24"
categories: [Measure theory, Gaussian measures]
description: "An introduction to Gaussian measure theory"
image: /assets/img/Collection_covers/cover_MC.jpg
...
Show that @gm-def is equivalent to requiring that that $\bm{\ell }_{\#}\mu$ is a Gaussian measure on $\Bb(\R^n)$ for all $\bm{\ell }:=(\ell_1,\ldots, \ell _n )$ where $\ell _1,\ldots, \ell _n \in E'$.
