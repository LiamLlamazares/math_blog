...
\begin{document}
\title{The Itô integral}
\postaliases{/2022-05-26-The-Ito-integral/}
\postsubtitle{Can you really construct this thing?}
\posttags{Stochastic Calculus, Ito Integral}
...
\begin{definition}
A stochastic process $\{X_t\}_{t\in I}$ valued in a measurable space $(H,\Hh)$ is \emph{adapted} if $X_t : \Ff_t \to \Hh$ for all $t \in I$.
\end{definition}
...
\begin{definition}\label{prog def}
	A stochastic process $\{X_t\}_{t\in I}$ valued in a measurable space $(H,\Hh)$ is \emph{progressively measurable} if its restriction to $[0,t]\times\Omega$ is measurable as a map $$X|_{[0,t]\times\Omega} : \Bb([0,t])\otimes\Ff_t\to \Hh$$ for all $t\in I$.
\end{definition}
...
\end{proof}
\section{Construction of the integral}
