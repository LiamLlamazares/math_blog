...
\begin{definition}
	A stochastic process $\{X_t\}_{t\in I}$ is \emph{progressively measurable} if its restriction to $[0,t]\times\Omega$ is measurable as a map $$X|_{[0,t]\times\Omega} : \Bb([0,t])\otimes\Ff_t\to \Hh$$ for all $t\in I$.
\end{definition}
