...
\end{theorem}
\begin{proof}
	We have already proved the above inequality for simple processes. By our previous post on the \postref{Analysis on Banach spaces/Bochner_integral}{}{Bochner integral}, we can take $X_n$ converging to $X$ in $L^1(\Omega\to E)$ to obtain that
	\begin{align*}
...
\begin{definition}
	...
	\begin{enumerate}
		...
		\item $M(t):\Ff_{t} \to \Bb(E)$ for all $t\in I$,
