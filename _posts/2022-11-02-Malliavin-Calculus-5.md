...
<div>
 $$\begin{aligned}
             ...
             & =\mathbb{E}\left[ \left(\int\U 1\U {X\leq x} g(x)dx\right)\delta\left(\frac{DX}{\norm{DX}^2\U {H}}\right)\right] =\int\U g(x)\mathbb{E}\left[ 1\U {X\leq x}\delta \left(\frac{DX}{\norm{DX}\U {H}^2}\right) \right]  \\&=\int\U g(x)p(x).
        \end{aligned}$$
</div>
