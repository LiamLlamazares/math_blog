...
$B(0,1) \cap \mathbb{R}^d\U +$ and then using a partition of unity and
...
$334-343$. For the partition to be finite, it is further necessary for
$\Omega$ to be bounded. We summarize the main results, which are
...
$b\U i,c \in L^\infty(\Omega)$. Let $u \in H^1\U 0(\Omega)$ be a weak
solution to (\ref{PDE}) .
Then, $u \in H^2(\Omega)$ with
