...
In the above theorem we commuted the sum with the _Itô integral_ (note the difference with the commutation in [Lemma 1](https://nowheredifferentiable.com/2022-05-29-Malliavin-Calculus-2/#:~:text=By%20commuting%20the%20sum)). We didn't completely justify this, we do so now.
