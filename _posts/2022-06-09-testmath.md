...
integrable martingales $\mathcal{M}_I^2$ as $$\begin{aligned}
        ...
        .\end{aligned}$$ Thus, it extends uniquely to the closure
...
$$\sup_{t\in I}  |X_n(t)-X_m(t)|>2^{-k},$$ which can be made small for
