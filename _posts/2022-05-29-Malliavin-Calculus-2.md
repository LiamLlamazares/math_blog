...
function of $n+1$ variables instead of $n$. Furthermore, by approximating $f$ by smooth functions and using the construction of $f\U n$, it is possible to show that $f\U n\in L^2(I^{n+1})$. In particular, we will be
