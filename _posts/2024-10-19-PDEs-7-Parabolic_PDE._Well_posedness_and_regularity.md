...
<img src="{{'assets/img/Figures/Galerkin_n_3.svg'| relative_url }}" alt="Galerkin solution to the parabolic problem (\ref{parabolic 2}) with n=3 basis functions" width="90%" id="fig:Galerkin_n_3">
