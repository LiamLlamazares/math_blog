...
And png is
<img src="{{'assets/img/Figures/regularity_coefficient.png'| relative_url }}" alt="Sobolev critical exponent for p=2 and d=1,2,3" width="80%" id="fig:regularity_coefficient">
