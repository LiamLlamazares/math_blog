...
**Proposition 3**. Let $U$ be a **bounded** open set with $C^1$
**boundary**. Then

<div>
$$\begin{aligned}
W^{k,p}\U 0(U)=\left\{u \in W^{k,p}(U): Tu=0\right\} .
\end{aligned}$$
</div>
...
<a name="extensiontrace">
**Exercise 21** (Extension trace 0). </a> Let $U$ be an open set, and define
...
The proof is technical and can be found in [7](https://link.springer.com/book/10.1007/978-0-387-70914-7) page 282.
...
3.  For the compactness of the last inclusion we use [Arzelà--Ascoli
    theorem](https://en.wikipedia.org/wiki/Arzel%C3%A0%E2%80%93Ascoli_theorem# <a name="simple embedding label="simple embedding""> :~:text=%2C%20%C2%A7IV.6.7)
...
Proof. The proof follows by combining the aforementioned results with the Extension result in Exercise [21](extensiontrace). See also Observation [4](traceobs). ◻
...
See for example [8](https://www.gbv.de/dms/goettingen/377412414.pdf) 444R.
...
say that a function $f:S \to \mathbb{R}$ is **$k$-times differentiable
at $p$** if there exists a function
